...
public class JSONParser {
    ...
    public JSONObject updatePosition(String url, String positionId, HashMap<String, String> updatedData) {
        try {
    ...
    public JSONObject deletePosition(String url, String positionId) {
        try {
            // Build the complete URL for the request, including the position ID
            url = url + "/" + positionId;
